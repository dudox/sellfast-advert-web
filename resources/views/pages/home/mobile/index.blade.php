        ...
        <div class="page-content header-clear-large">
            ...
            <div class="content-title bottom-20">
                ...
                <div style="padding: 0px">
                    <div  class="content call-to-action-1">
                        <a href="javascript:void(0)" data-menu="menu-premium"  class="shadow-small button button-s button-center-large button-rounded bg-highlight uppercase ultrabold"  style="background: #fbbc24 !important; color:#000; width:100% !important;border: none !important">
                            Premium pack ( Proceed ) <i  class="fa fa-arrow-right" style="position: absolute; right:20px !important; top:15px"></i>
                        </a>
                    ...
                    <div  class="content call-to-action-1">
                        <a href="javascript:void(0)" data-menu="menu-vip" class="shadow-small button button-s button-center-large button-rounded bg-highlight uppercase ultrabold" style="background: #39b759 !important; color:#000; width:100% !important;border: none !important">
                            VIP pack ( Proceed ) <i  class="fa fa-arrow-right" style="position: absolute; right:20px !important; top:15px"></i>
                        </a>
