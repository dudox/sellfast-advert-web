...
<script type="text/javascript">
    ...
    $('.demo-green').on('click', function() {
        $('.demo-colors-select a').removeClass('active-demo-color');
        $(this).addClass('active-demo-color');
        $('#page-transitions').removeClass(highlights).addClass('highlight-green');
    });
    $('.demo-red').on('click', function() {
        $('.demo-colors-select a').removeClass('active-demo-color');
        $(this).addClass('active-demo-color');
        $('#page-transitions').removeClass(highlights).addClass('highlight-red');
    });
    $('.demo-blue').on('click', function() {
        $('.demo-colors-select a').removeClass('active-demo-color');
        $(this).addClass('active-demo-color');
        $('#page-transitions').removeClass(highlights).addClass('highlight-blue');
    });
    $('.demo-orange').on('click', function() {
        $('.demo-colors-select a').removeClass('active-demo-color');
        $(this).addClass('active-demo-color');
        $('#page-transitions').removeClass(highlights).addClass('highlight-orange');
    });
    $('.demo-magenta').on('click', function() {
        $('.demo-colors-select a').removeClass('active-demo-color');
        $(this).addClass('active-demo-color');
        $('#page-transitions').removeClass(highlights).addClass('highlight-magenta');
    });
    $('.demo-simple').on('click', function() {
        $('.demo-colors-select a').removeClass('active-demo-color');
        $(this).addClass('active-demo-color');
        $('#page-transitions').removeClass(highlights).addClass('highlight-simple');
    });
    ...
    if ($('#page-transitions').hasClass('dark-skin')) {
        $('.toggle-dark-mode').addClass('toggle-active');
    }
